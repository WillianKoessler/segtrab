...
function IdentificationItem({ id, display, specs }) {
    ...
    return {
        ...
        children: [
            ...
            {
                tag: 'input',
                className: "rounded border border-blue-300 px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-1 focus:ring-blue-400 print:p-0 print:text-gray-800 print:border-none print:bg-transparent",
...
function HiddenData() {
    ...
    function CargoItem(cargo, index) {
        const storeData = () => dispatch({
            type: "set:cargos",
            payload: { index, value: cargo }
        });
                ...
                },
                {
                    ...
                    children: cargo.responses.map((response, i) => ({
                        ...
                        children: [
                            ...
                            {
                                tag: 'input',
                                onchange: e => handleResponseChange(i, e.currentTarget.value),
                                type: 'number',
                                max: 100,
                                min: 0,
...
export default function SectionIdentificacao(index, id, title) {
    return Section(index, id, title, [
        ...
        {
            tag: 'div',
            className: "print:hidden bg-gray-100 p-4 rounded-lg border-l-4 border-red-200 flex flex-col items-start",
            children: [
